                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            <div>
                                ...
                                <div class="mt-4">
                                    <a href="#" class="btn btn-outline-white">Solicitar Vehículos</a>
                                </div>
                                <div class="mt-4">
                                    <a href="http://localhost/FCC/usuario.php" class="btn btn-outline-white">Datos de usuario</a>
                                </div>
                                <div class="mt-4">
                                    <a href="http://localhost/FCC/usuario.php" class="btn btn-outline-white">Validar solicitudes</a>
                                </div>
                            </div>
                        </div><!-- end col -->
                    </div><!-- end row -->
